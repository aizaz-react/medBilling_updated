...
export const aboutCardData = [
  { icon: "", percentage: "98%", title: "Clean Claims Acceptance" },
  { icon: "", percentage: "08%", title: "Monthly Denials" },
  { icon: "", percentage: "96%", title: "Electronic Claims Submission" },
  { icon: "", percentage: "99%", title: "Credentialing Success" },
  { icon: "", percentage: "96%", title: "Bank Direct Deposit" },
  { icon: "", percentage: "10% - 15%", title: "Practise Growth" },
  { icon: "", percentage: "10Y", title: "Team Avg. Expertise" },
  { icon: "", percentage: "95%", title: "Electronic Payments" },
];
