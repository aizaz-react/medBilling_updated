...
import CredentialingIcon from "../svgicons/carbon_credentials.svg";
import MedicalCodingIcon from "../svgicons/devices-minus.svg";
import MedicalBillingIcon from "../svgicons/bottle.svg";
import PractiseIcon from "../svgicons/brand-google-analytics.svg";
import ExeptionalIcon from "../svgicons/hands.svg";
import RapidIcon from "../svgicons/bolt.svg";
import ClaimIcon from "../svgicons/id.svg";
import ControlledIcon from "../svgicons/calcu.svg";
import ElectronicIcon from "../svgicons/device-ipad.svg";
import SuccessIcon from "../svgicons/mdi_account-success-outline.svg";
import Elecpaymenticon from "../svgicons/license.svg";
import AuditIcon from "../svgicons/teenyicons_code-solid.svg";
import GrowthIcon from "../svgicons/fluent_arrow-growth-24-regular.svg";
import AgreementIcon from "../svgicons/icon-park-outline_agreement.svg";
import PartyIcon from "../svgicons/solar_bill-list-linear.svg";
import SpecialIcon from "../svgicons/material-symbols-light_folder-special-outline.svg";
import ComplaintIcon from "../svgicons/icons8_organization.svg";
...
import ClaimSubmissionIcon from "../svgicons/iconoir_submit-document.svg";
import CredentialinSuccessIcon from "../svgicons/icon-park-outline_success.svg";
import BankDepositeIcon from "../svgicons/vaadin_money-deposit.svg";
...
export const aboutCardData = [
  { percentage: "98%", title: "Clean Claims Acceptance", icon: CleanClaimIcon },
  { percentage: "08%", title: "Monthly Denials", icon: MonthlyDenialIcon },
  {
    percentage: "96%",
  ...
  {
    percentage: "99%",
    title: "Credentialing Success",
    icon: CredentialinSuccessIcon,
  },
  { percentage: "96%", title: "Bank Direct Deposit", icon: BankDepositeIcon },
  { percentage: "10% - 15%", title: "Practise Growth", icon: PracitseGrowIcon },
  { percentage: "10Y", title: "Team Avg. Expertise", icon: ExpertiesIcon },
  { percentage: "95%", title: "Electronic Payments", icon: EelctroPayIcon },
];
